...
\begin{itemize}
	  ...
	  \item skuteczność - $5\%$ \todo{wydzielic}
	\end{itemize}
...
confide in me--fear not--i am a mother!
	\end{bash}
	Widać zmapowane duże znaki na małe. Jest to zachowanie oczekiwane. \todo{wyjasnic, sprawdzic}
...
W skład sprawdzenia modułu sieci wchodziły następujące kroki:
	\begin{itemize} 
	  ...
	  do którego zbiegały.} \todo{komentarz, manifestacja bledu wykrytego dalej}
	\end{itemize}
...
Stworzyliśmy uproszczony model w bibliotece Keras + \todo{wersja + do bibliotek} , który uczył się przewidywać kolejne znaki na podstawie podanego tekstu. 
...
niska skuteczność spowodowana była eksplozją gradientu. \todo{przemyslec, gradient clipping, spojnosc}
