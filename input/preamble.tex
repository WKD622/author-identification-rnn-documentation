...
\author{Jan Liberacki, Jakub Ziarko}

\titlePL{Aplikacja do identyfikacji autorów w oparciu o sieci neuronowe}
\titleEN{Application for author identification based on neural networks}

\fieldofstudy{Informatyka}

\supervisor{dr inż.\ Marcin Kuta}
