...
\begin{enumerate}
	...
	wynikowe dla danej nazwy zlecenia w folderze results. Nazwa zlecenia to ostatni wyraz dla składnika name,
	...
	W folderze każdego zlecenia inicjalizowanych jest 5 plików: 
	...
	\end{import}
	  ...
	  Przykładowa zawartość pliku:
	  	  \begin{import}	
model,epoch,loss,accuracy,time
...
4,4,0.7149949056285243,0.382658226754242341,1:58:06.904183
	...
	Uruchumiony szuka folderu results w folderze w którym się aktualnie znajduje. Następnie iteruje po folderach
	wykonanych zadań z folderu results, z każdego z nich czyta plik results.csv i rysuje dla niego wykres kosztu od epoki
 	oraz skuteczności od epoki. Wykresy zapisuje w folderze \texttt{plots}, gdzie każde zlecenie ma osobny folder
 	o swojej nazwie.
