...
wciąż można poprawić rezultaty,co jest również celem tej pracy.\todo{opisac lepiej ta poprawe wynikow}
...
nieznane, na podstawie porównania ze stylami językowymi osób piszących w tamtym okresie czasu.\todo{plagiat na koniec + lepsze przyklady}

\subsection{Wizja}
Wizją tej pracy jest stworzenie dopracowanej biblioteki pozwalającej na konfigurowalne tworzenie 
głębokich sieci typu RNN\todo{rozwiniecie}, ich trening, oraz preprocesing danych wejściowych. Oprócz tego powinna ona 
