...
\vspace{-4mm}
\end{wrapfigure}
\TODO{dopisac o ukrytym}
Funkcja odwzorowująca wejście na wyjście jest dokładnie tą samą przez cały proces
...
%\TODO{theta - konlkrente funkcje, f_h f_o bez indeksow prawdopdobien}
